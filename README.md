...
Estas son las tecnologías con las que trabajo y sigo aprendiendo día a día:
...
* ![Git](https://img.shields.io/badge/-Git-F05032?style=flat&logo=git&logoColor=white) * ![Vercel](https://img.shields.io/badge/-Vercel-000000?style=flat&logo=vercel&logoColor=white)
...
* Reforzando mis habilidades en **Inglés técnico y conversacional**.
* Profundizando en arquitecturas limpias y buenas prácticas en **Java** y **JavaScript**.
* Mejorando la seguridad y autenticación (JWT, roles) en mis aplicaciones Backend.
